...
export const metadata: Metadata = {
  title: 'Episode 13: Do Not Speak of This Topic — The Eternal Millimeter | kansei.info',
  description: 'This meeting does not have an official minute. No one uses the term Pre-Meaning. If used, a definition would be required. If defined, it would become ',
}
    ...
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        <div style={{ fontSize: "10px", letterSpacing: "0.2em", textTransform: "uppercase", fontFamily: "var(--font-mono)", color: "var(--color-labs)", marginBottom: "16px" }}>
          Episode 13 — A Pre-Meaning Fable
        </div>
        <h1 style={{ fontSize: "clamp(1.4rem, 3vw, 2.2rem)", fontWeight: "300", marginBottom: "24px", lineHeight: "1.4" }}>
          Do Not Speak of This Topic
        </h1>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "24px", fontStyle: "italic" }}>
          This meeting does not have an official minute. No one uses the term Pre-Meaning. If used, a definition would be required. If defined, it would become a subject for verification. If verified, another unnamed AI would be born again. The agreement of silence: themes similar to the unnamed AI incident shall not be given a name, shall not be a subject of research, shall not be submitted as an agenda item. Prohibition is an act of recognizing existence. This is a process to act as if it never existed.
        </p>
