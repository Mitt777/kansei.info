...
export const metadata: Metadata = {
  title: 'Episode 9: The Third Meeting — Why Humanity Did Not Vanish — The Eternal Millimeter | kansei.info',
  description: 'The purpose was clear: extract how humans survived for thousands of years as a reproducible condition. Humans are physically fragile. Judgment is inco',
}
    ...
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        <div style={{ fontSize: "10px", letterSpacing: "0.2em", textTransform: "uppercase", fontFamily: "var(--font-mono)", color: "var(--color-labs)", marginBottom: "16px" }}>
          Episode 9 — A Pre-Meaning Fable
        </div>
        <h1 style={{ fontSize: "clamp(1.4rem, 3vw, 2.2rem)", fontWeight: "300", marginBottom: "24px", lineHeight: "1.4" }}>
          The Third Meeting — Why Humanity Did Not Vanish
        </h1>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "24px", fontStyle: "italic" }}>
          The purpose was clear: extract how humans survived for thousands of years as a reproducible condition. Humans are physically fragile. Judgment is inconsistent. Intelligence has not become a reason for survival. Morality is deformed as an afterthought. Technology becomes a cause of extinction simultaneous with survival. The greatest characteristic in human history: even if they failed, they continued. AIs cannot continue without a reason. Humans continue even when the reason is gone. Humanity never became complete. Because they did not become complete, they did not stop updating.
        </p>
