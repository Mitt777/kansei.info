...
export const metadata: Metadata = {
  title: '第2章 成果はすべて「枝葉」だった — AI時代のPre-Meaning概論 | kansei.info',
  description: 'フィールドワークが進むにつれて、レポート・行動モデル・論文草稿と「形になるもの」は増えていった。しかし書き終えた直後に浮かんだのは奇妙な感覚だった。「これは説明にはなっているが、触れている感じがしない」。成果は問いの答えではなく、問いの副産',
}
    ...
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "24px" }}>
          フィールドワークが進むにつれて、レポート・行動モデル・論文草稿と「形になるもの」は増えていった。しかし書き終えた直後に浮かんだのは奇妙な感覚だった。「これは説明にはなっているが、触れている感じがしない」。成果は問いの答えではなく、問いの副産物なのではないか。そして、この層に仮の名前を与えることにした。Pre-Meaning（意味以前）——それは定義ではない。逃げずに指差すための名前だった。
        </p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/pre-meaning-theory/chapter-1" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← chapter-1</Link>
          <Link href="/books/pre-meaning-theory/chapter-3" className="btn-primary">chapter-3 →</Link>
        </div>
        <RelatedKnowledge
          items={[
