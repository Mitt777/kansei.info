...
export const metadata: Metadata = {
  title: '第6章 日本で起きる静かな起業爆発 — AI失業2026 クリエイター・フリーランス編 | kansei.info',
  description: '日本で起きる静かな起業爆発。AI失業2026 クリエイター・フリーランス編・第6章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>日本で起きる「静かな起業爆発」</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>― ソロプレナーはどこから生まれるのか</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>革命は、突然起きるように見える。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>だが実際には、長い準備期間がある。</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-creator/chapter-5" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← 第5章</Link>
          <Link href="/books/ai-creator/chapter-7" className="btn-primary">第7章 →</Link>
        </div>
