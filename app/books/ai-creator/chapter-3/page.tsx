...
export const metadata: Metadata = {
  title: '第3章 なぜ35人の仕事が1人で可能になったのか — AI失業2026 クリエイター・フリーランス編 | kansei.info',
  description: 'なぜ35人の仕事が1人で可能になったのか。AI失業2026 クリエイター・フリーランス編・第3章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
    ...
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <h1 style={{ fontSize: "clamp(1.4rem, 3vw, 2.2rem)", fontWeight: "300", marginBottom: "24px", lineHeight: "1.4" }}>
          なぜ35人の仕事が1人で可能になったのか
        </h1>

        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>なぜ35人の仕事が1人で可能になったのか</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>― 分解された企業の「7つの機能」</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>この問いに対して、多くの人は抽象的に答える。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>組織。
チーム。
人の集まり。</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-creator/chapter-2" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← 第2章</Link>
          <Link href="/books/ai-creator/chapter-4" className="btn-primary">第4章 →</Link>
        </div>
