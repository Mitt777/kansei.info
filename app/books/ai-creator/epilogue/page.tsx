...
export const metadata: Metadata = {
  title: '最終章 目指せ、ソロプレナー — AI失業2026 クリエイター・フリーランス編 | kansei.info',
  description: '目指せ、ソロプレナー。AI失業2026 クリエイター・フリーランス編・最終章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>― AI時代に生き残る唯一の道</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>ここまで、本書はひとつの変化を追ってきた。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>フリーランスの変化。
企業の変化。
労働の変化。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>だが、本当に変わっているのは、</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-creator/chapter-8" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← 第8章</Link>
