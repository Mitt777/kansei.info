...
export const metadata: Metadata = {
  title: '第5章 消える者と、拡張される者 — AI失業2026 クリエイター・フリーランス編 | kansei.info',
  description: '消える者と、拡張される者。AI失業2026 クリエイター・フリーランス編・第5章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>消える者と、拡張される者</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>― AI時代の新しい階級構造</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>Shopify CEO の歴史的宣言</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>オンラインショップ大手企業・ShopifyのCEO、Tobias Lütkeは、</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-creator/chapter-4" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← 第4章</Link>
          <Link href="/books/ai-creator/chapter-6" className="btn-primary">第6章 →</Link>
        </div>
