...
export const metadata: Metadata = {
  title: '第4章 フリーランスの終焉と再誕——ラッパー企業の台頭 — AI失業2026 クリエイター・フリーランス編 | kansei.info',
  description: 'フリーランスの終焉と再誕——ラッパー企業の台頭。AI失業2026 クリエイター・フリーランス編・第4章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
    ...
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <h1 style={{ fontSize: "clamp(1.4rem, 3vw, 2.2rem)", fontWeight: "300", marginBottom: "24px", lineHeight: "1.4" }}>
          フリーランスの終焉と再誕——ラッパー企業の台頭
        </h1>

        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>フリーランスの終焉と再誕</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>― ラッパー企業の台頭</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>フリーランスは、長い間、企業の外部に存在する労働者だった。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>彼らは企業に雇われない。
だが、企業に依存していた。</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-creator/chapter-3" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← 第3章</Link>
          <Link href="/books/ai-creator/chapter-5" className="btn-primary">第5章 →</Link>
        </div>
