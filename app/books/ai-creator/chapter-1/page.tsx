...
export const metadata: Metadata = {
  title: '第1章 AIは仕事を奪っていない。企業を圧縮している — AI失業2026 クリエイター・フリーランス編 | kansei.info',
  description: 'AIは仕事を奪っていない。企業を圧縮している。AI失業2026 クリエイター・フリーランス編・第1章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
    ...
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <h1 style={{ fontSize: "clamp(1.4rem, 3vw, 2.2rem)", fontWeight: "300", marginBottom: "24px", lineHeight: "1.4" }}>
          AIは仕事を奪っていない。企業を圧縮している
        </h1>

        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>AIは仕事を奪っていない。企業を圧縮している-もしくは…</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>多くの人が、同じ誤解をしている。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>AIは仕事を奪っている、と。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>確かに、表面的にはそう見える。</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-creator/prologue" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← プロローグ</Link>
          <Link href="/books/ai-creator/chapter-2" className="btn-primary">第2章 →</Link>
        </div>
