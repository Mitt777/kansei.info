...
export const metadata: Metadata = {
  title: '第2章 地方店舗にAIが来る — AI失業2026 一次産業・地方店舗復活編 | kansei.info',
  description: '地方店舗にAIが来る。AI失業2026 一次産業・地方店舗復活編・第2章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>米国では、農家は「ブランド」になった（データ補強版）</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>農業の変化は、生産技術だけではない。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>より大きな変化は、
流通の構造で起きている。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>20世紀型農業では、農家は生産者であり、
販売は卸や流通業者が担っていた。</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <Link href="/books/ai-local/chapter-1" style={{ fontSize: "13px", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)" }}>← 第1章</Link>
          <Link href="/books/ai-local/chapter-3" className="btn-primary">第3章 →</Link>
        </div>
