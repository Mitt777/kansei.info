...
export const metadata: Metadata = {
  title: '第1章 シリコンバレーは、農業を再発明している — AI失業2026 一次産業・地方店舗復活編 | kansei.info',
  description: 'シリコンバレーは、農業を再発明している。AI失業2026 一次産業・地方店舗復活編・第1章。藤井実彦著。AI時代の雇用・居場所・感性の関係を論じる。',
}
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>## シリコンバレーは、農業を再発明している（データ補強版）</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>農業は、最も古い産業である。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>そしていま、最も新しい産業になろうとしている。</p>
        <p style={{ fontSize: "15px", lineHeight: "1.95", color: "var(--color-text-sub)", marginBottom: "20px" }}>2010年代後半から、米国ではアグリテック（AgTech）投資が急拡大した。</p>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <span />
          <Link href="/books/ai-local/chapter-2" className="btn-primary">第2章 →</Link>
        </div>
